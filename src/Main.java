...
public class Main {
    public static void main(String[] args) {
        ...
        Paciente paciente1 = new Paciente("Renglyn", 23, "Masculino", "Calle transito rojas", "Historial 1", "Seguro 1");
        Paciente paciente2 = new Paciente("Leslie", 30, "Femenino", "Calle 12", "Historial 2", "Seguro 2");

        Medico medico1 = new Medico("Dr. oscar", 23, "Masculino", "Avenida 723", "Cardiología", "12345", "Lunes 9-12");
        Medico medico2 = new Medico("Dra. reina", 35, "Femenino", "Avenida 987", "Dermatología", "67890", "Martes 14-17");
